...
if __name__ == '__main__':
    ...
    tree.insert_root(10)
    root = tree.getroot()
    tree.insert_child_bst(root, 20)
    tree.insert_child_bst(root, 15)
    tree.insert_child_bst(root, 17)
    tree.insert_child_bst(root, 13)
    print(f'Search Result : {tree.search(root, 13)}')
    print(f'Search Result : {tree.search(root, 100)}')
